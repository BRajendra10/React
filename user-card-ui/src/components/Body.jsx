...
function Body() {
    const [followers, setFollowers] = useState(84);
    ...
    return (
        <div className=" w-full relative top-[77px] px-3">
            <div className="flex justify-between items-center">
                ...
                <button className="bg-blue-500 text-zinc-50 py-2 px-7 rounded-full" onClick={() => handleClick()}>Follow</button>
            </div>
            ...
            <div className="mt-2">
                <a href="#" className="flex justify-start items-center gap-2 text-blue-500">
                    <IoMdLink />
